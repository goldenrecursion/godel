...
def query_deprecated_get_triple_for_validation():
    _op = sgqlc.operation.Operation(_schema_root.query_type, name='DeprecatedGetTripleForValidation')
...
class Query:
    deprecated_get_triple_for_validation = query_deprecated_get_triple_for_validation()
